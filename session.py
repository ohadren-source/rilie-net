        ...
        with get_db_conn() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    ...
                    "turn_count, whosonfirst, greeting_count, response_history, talk_served, social_state, "
...
def save_session(session: Dict[str, Any]) -> None:
    ...
    INSERT INTO banks_sessions
        (session_id, user_name, client_ip, name_source, turn_count, whosonfirst,
         greeting_count, response_history, talk_served, social_state, topics,
    ...
    ON CONFLICT (session_id) DO UPDATE SET
        ...
        greeting_count = EXCLUDED.greeting_count,
