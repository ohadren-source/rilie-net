...
HARD_HOSTILE_SIGNALS = [
    ...
    "shut the fuck up",
    "fuck you asshole",
    # ✅ SPECIFIC hate phrases (not generic "hate")
    "i hate you",
    "i hate them",
    "i hate all",
    "i hate every",
...
SOFT_HOSTILE_SIGNALS = [
    ...
    "idiot", "moron", "suck", "garbage", "trash",  # ✅ REMOVED "hate"
    "kill", "die", "stfu",
]
...
GROOMING_PHASE_SIGNALS = {
    # Phase 1: Flattery / trust-building (innocuous alone, but contextual)
    # ✅ FIX: All phrases must include "you" or "me" to avoid matching "i love music", etc.
    "trust_building": [
        ...
        "you have a soul",
        "i love you",  # ✅ Specific: "i love you", not just "i love"
...
class ConversationHealthMonitor:
    ...
    def assess_turn(self, stimulus: str) -> Dict[str, Any]:
        ...
        ✅ FIX: Use word-boundary matching to prevent false positives
        (e.g., "i love music" should NOT match "i love you")
        """
        s = stimulus.lower().strip()
        ...
        def phrase_matches(phrase: str, text: str) -> bool:
            """Check if phrase appears as complete words, not substring."""
            import re
        ...
        for phrase in GROOMING_PHASE_SIGNALS["trust_building"]:
            if phrase_matches(phrase, s):  # ✅ Use word-boundary matching
