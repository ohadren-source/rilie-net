...
def _get_self_answer(stimulus: str) -> Optional[str]:
    ...
    # You vs ChatGPT / other AI — FIX 1: dynamic AI name
    _AI_NAMES = {
...
def construct_response(stimulus: str, snippet: str) -> str:
    ...
    if _is_self_question(stimulus):
        ...
        # Full sentence about self — pass through
...
def generate_9_interpretations(
    ...
    # --- Relevance + Resonance scoring (closure over stimulus/domains) ---
...
def run_pass_pipeline(
    ...
    for current_pass in range(1, max_pass + 1):
        ...
        filtered = [
            ...
            for i in nine
            if (i.overall_score > (
                    # FIX 5: factual domains get a lower gate — less fallthrough to baseline
